package com.dw.sodetail;

/**
 * Created by dw on 18-11-15.
 */
...
public class EncodeSection {
    ...
    public static void main(String[] args){
        ...
        byte[] fileByteArys = Utils.readFile("src/com/dw/sodetail/libmyso.so");
        ...
        Utils.saveFile("src/com/dw/sodetail/mmyso", fileByteArys);
    ...
    private static void encodeSection(byte[] fileByteArys){
        ...
        //修改Elf Header中的e_entry和e_shoff值
...
//        Utils.replaceByteAry(fileByteArys, 12, offsetAry);//存储信息在e_ident[16]后四个字节中
        Utils.replaceByteAry(fileByteArys, 36, offsetAry);//存储信息在e_flags中
    }
